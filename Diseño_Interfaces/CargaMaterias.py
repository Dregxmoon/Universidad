...
class CargaMaterias(QWidget):
    ...
    def init_ui(self):
        ...
        self.btn_carga_paquete = QPushButton("Carga Automática por Paquete")
        self.btn_carga_paquete.setStyleSheet(
            "background: #00bcd4; color: white; padding: 10px; border-radius: 8px;"
        )
        ...
        botones_layout.addWidget(self.btn_carga_paquete)
